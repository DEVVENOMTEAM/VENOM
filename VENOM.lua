...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,2032996533,2048779971}
...
local NameUser = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/venom_source)\n — — — — — — — — —\n❈︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/venom_source)\n — — — — — — — — —\n❈︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/venom_source)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "venom_source")..")".."\n❈︙تم رفعه "..RTPA.." هنا\n")
...
if VENOMrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/venom_source)\n — — — — — — — — —\n❈︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "venom_source")..")".."\n❈︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."VENOM:Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'VENOM')..') '
...
t = t.."❈︙"..x.."︙[@"..database:get(bot_id.."VENOM:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if text == (database:get(bot_id.."VENOM:Name:Bot") or "فينوم") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."VENOM:Name:Bot") or "فينوم")
local namebot = {
...
if DevVENOM(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/VENOM/files_VENOM/master/getfile.json")
if res == 200 then
...
send(msg.chat_id_,msg.id_,'❈︙شترك في قناة السورس اولآ @venom_source .')   
return false 
end
key = {
{{text = '- ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ .',url="t.me/venom_source"}},
{{text = '- ᴛᴡ ʙᴏᴛ .',url="t.me/wkwvbot"}},
}
...
send(msg.chat_id_, msg.id_,'❈︙عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'VENOM:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
x = {} 
x.inline_keyboard = {
{{text = '❈︙ BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/venom_source'}},
}
...
inline = {
{{text = '❈︙ BLacK 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/venom_source'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."VENOM:Name:Bot") or "فينوم")
